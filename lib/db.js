...
// Conclusions that have a reexamination certificate (RXCERT) but no parsed outcome
// yet. NIRC-only proceedings are intentionally excluded — only the certificate
// determines the claim outcome / concluded status.
