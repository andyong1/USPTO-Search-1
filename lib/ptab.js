...
import { classifyFwd } from './ptab-classify.js';

// Re-export the pure classifier so callers can import everything from lib/ptab.js.
export { classifyFwd, CLASSIFIER_V, FWD_OUTCOMES } from './ptab-classify.js';
