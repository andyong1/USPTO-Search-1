...
function ptabDecisionsSection(items) {
  ...
  return `<div style="margin:0 0 26px"><h3 style="margin:0 0 4px;font-size:15px;color:#1a3a6b">6. PTAB Discretionary &amp; Institution Decisions</h3>${table}</div>`;
}
...
function ptabSection(ptab) {
  ...
  return `<div style="margin:0 0 26px"><h3 style="margin:0 0 4px;font-size:15px;color:#1a3a6b">7. PTAB Final Written Decisions</h3><p style="color:#718096;font-size:12px;margin:0 0 6px">Outcome is not yet classified on the day of issuance — open the trial page for the parsed result.</p>${table}</div>`;
}
