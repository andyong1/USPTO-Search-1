...
// ── PTAB FWD tracker ────────────────────────────────────────────────
export async function upsertPtabFwd(r) {
  await ensureSchema();
  await sql`
    INSERT INTO ptab_fwd (trial_number, trial_type, patent_number, application_number, tech_center,
      ...
      institution_date, fwd_date, outcome, outcome_detail, fwd_doc_id, fwd_pdf_url)
    VALUES (${r.trial_number}, ${r.trial_type}, ${r.patent_number}, ${r.application_number}, ${r.tech_center},
      ...
      ${r.institution_date}, ${r.fwd_date}, ${r.outcome}, ${r.outcome_detail}, ${r.fwd_doc_id}, ${r.fwd_pdf_url})
