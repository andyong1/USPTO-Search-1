...
export function dispositiveRole(type, title) {
  ...
  if (t === 'notice') {
    // Commission action notices — make an ID final, terminate, or decide review.
    if (/determination|to review|not to review|terminat|violation|remedy/.test(ti)) return 'commission_notice';
  }
