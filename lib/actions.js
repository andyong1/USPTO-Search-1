...
export async function detectActionsForApp(appNum, orderDate) {
  ...
  // Outlier flag (DA-11): identical non-final/final dates or an implausible
  // action count indicate a mis-coded docket — verify before it enters timing stats.
  const reviewFlag = !!(nonf && finl && nonf.officialDate === finl.officialDate) || actionCount > 8;
